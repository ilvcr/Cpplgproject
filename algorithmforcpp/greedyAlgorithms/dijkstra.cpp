...
> Created Time: 2018年07月24日 星期二 14时51分02秒
> Description: 
 ************************************************************************/
...
//The main function that finds the shortest path from given source to all other 
//vertices using Dijkstra's Algorithm.It doesn't work on negative weights
void Dijkstra(graph graph, int src){
    ...
    //iterator to find shortest path
